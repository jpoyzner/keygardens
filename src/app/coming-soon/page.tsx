...
export default async function ComingSoonPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-8 rounded-lg border border-white bg-black my-8 px-4 py-8">
      <div className="flex flex-col gap-2 text-center">
        <h1 className="text-2xl font-semibold">Coming soon</h1>
        <p className="text-zinc-200">A preview of what&apos;s next at Keygardens.</p>
      </div>

      <ComingSoonSlideshow slides={slides} />

      <div className="flex flex-col gap-2 border-t border-zinc-700 pt-6">
